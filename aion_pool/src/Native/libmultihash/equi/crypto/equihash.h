...
extern const char* zcash_pow;
extern const char* aion_pow;
...
public:
    ...
    enum : size_t { HashLen=(N%8 == 0 ? N/8 : (N+7)/8) };
    ...
    int InitialiseState(eh_HashState& base_state, const char* personal);
#ifdef ENABLE_MINING
...
#define EhInitialiseState(n, k, base_state)  \
    if (n == 96 && k == 3) {                 \
        ...
        Eh210_9.InitialiseState(base_state, aion_pow); \
    } else {                                 \
